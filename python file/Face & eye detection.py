...
face_classifier = cv2.CascadeClassifier(r'C:\Users\mhetr\Downloads\13th- Haar cascade classifier\Haarcascades\haarcascade_frontalface_default.xml')
eye_classifier = cv2.CascadeClassifier(r"C:\Users\mhetr\Downloads\13th- Haar cascade classifier\Haarcascades\haarcascade_eye.xml")
...
img = cv2.imread(r"C:\Users\mhetr\OneDrive\Desktop\OIP (4).webp")
